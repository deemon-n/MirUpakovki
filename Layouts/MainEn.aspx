<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MainEn.aspx.cs" Inherits="MirUpakLayoutEn"
...
<body>
    ...
    <form id="muen" runat="server">
        ...
        <div id="toprght">
            <div class="topmenu"><a href="<%=AppPath %>/en/about/">About us</a></div>
            <div class="topmenu wide"><a href="<%=AppPath %>/en/suppliers/">Information for potential suppliers</a></div>
            <div class="topmenu"><a href="<%=AppPath %>/en/contacts/">Contacts</a></div>
        </div>
        ...
        <div id="content">
            ...
            <div id="foo">
                <div class="col">
                    <div><a href="<%=AppPath %>/en/about/">About us</a></div>
                </div>
                <div class="col">
                    <div><a href="<%=AppPath %>/en/suppliers/">Information for potential suppliers</a></div>
                </div>
                <div class="col">
                    <div><a href="<%=AppPath %>/en/contacts/">Contacts</a></div>
                </div>
                
                <div>&copy; <%=DateTime.Now.Year %> Group of companies «Mir upakovki»</div>
                <div>156009, Russia, Kostroma, Ubileynaya str., 24</div>
                <div>òåë.: +7 (4942) 440-888</div>
