...
<div style="width: 980px; margin: 0 auto;" class="assort">
    ...
    <h2 style="font-size: 28px; text-transform: uppercase; text-align: center;">23 года безупречной работы</h2>
    <img src="<%=AppPath %>/ii/achbar_new2.png" alt="" />
    ...
    <div id="ftext">
        <div class="ftext">
            <p>Хочу высказать благодарность компании «Мир упаковки» за своевременное предоставление пищевых контейнеров, стрейч плёнки и скотча с логотипом компании по особому заказу для моего производства.</p>
